...
// int32 applyuid = 2;
inline void RplyFriendRsp::clear_applyuid() {
  applyuid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RplyFriendRsp::_internal_applyuid() const {
  return applyuid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RplyFriendRsp::applyuid() const {
  // @@protoc_insertion_point(field_get:message.RplyFriendRsp.applyuid)
  return _internal_applyuid();
}
inline void RplyFriendRsp::_internal_set_applyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  applyuid_ = value;
}
inline void RplyFriendRsp::set_applyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_applyuid(value);
  // @@protoc_insertion_point(field_set:message.RplyFriendRsp.applyuid)
}
